...
\input{Appendix/datasamples}
\input{Appendix/signalsamples}
\input{Appendix/bkgsamples}

\chapter{Trigger efficiencies and Monte Carlo correction factors}
\label{sec:hltsf}
\input{Appendix/hlt_scalefactors}

\chapter{Lepton identification requirements and efficiencies}
\label{sec:datamcsf}
\input{Appendix/leptonid}
\input{Appendix/datamc_scalefactors}

\chapter{Systematic uncertainties on the signal}
\label{sec:appsyst}
\input{Appendix/SignalSyst}
